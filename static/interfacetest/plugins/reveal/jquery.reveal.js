/*
onclick前面的是添加事件的对象，对象要添加data-reveal-id（对应控制的div id）与data-animation（弹出方式）属性
对应div设置 id、class="reveal-modal"
<a class="close-reveal-modal">&#215;</a>是右上角关闭按钮
*/
        ...
        return this.each(function () {
            ...
            modal.bind('reveal:close', function () {
                if (!locked) {
                    ...
                    $('.reveal-modal input.delbtn').each(function (e) {     //表格重置
                        $(this).click();
                    });
                }
